...
void test_fact_0(void) { TEST_ASSERT_EQUAL(0, fact(0)); }
void test_fact_1(void) { TEST_ASSERT_EQUAL(1, fact(1)); }
void test_fact_2(void) { TEST_ASSERT_EQUAL(2, fact(2)); }
void test_fact_3(void) { TEST_ASSERT_EQUAL(6, fact(3)); }
void test_fact_10(void) { TEST_ASSERT_EQUAL(3628800, fact(10)); }
...
void test_fib_6(void) { TEST_ASSERT_EQUAL(8, fib(6)); }
void test_fib_7(void) { TEST_ASSERT_EQUAL(13, fib(7)); }
void test_fib_8(void) { TEST_ASSERT_EQUAL(21, fib(8)); }
void test_fib_9(void) { TEST_ASSERT_EQUAL(34, fib(9)); }
...
int main(void) {
    ...
    RUN_TEST(test_fact_0);
    RUN_TEST(test_fact_1);
    RUN_TEST(test_fact_2);
    RUN_TEST(test_fact_3);
    RUN_TEST(test_fact_10);
